...
"http://www.iconninja.com/files/929/296/21/headset-person-man-avatar-support-male-young-icon.svg" 
          alt="Avatar">
        </div>
        <div class="name">{{currentProfile.username}}</div>
        <div class="separateName"></div>
        <div class="description">
Quis potenti nam lacus eros euismod
...
Dictum conubia consectetur curae amet ultrices lorem orci mauris ligula sit torquent
       </div>
    </div>
  `,
